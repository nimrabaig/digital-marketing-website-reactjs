...
import { CREATE_BLOG, CREATE_JOB } from "../../helpers/Mutations";
import { BLOG_CATEGORY_DD, JOB_CATEGORY_DD } from "../../helpers/Queries";
...
const Admin_CareerCreate = () => {
    ...
    const [createJobFunc, createJob] = useMutation(CREATE_JOB)


    const handleSubmit = async (dataItem) => {
        setBtnDisabled(true)
        console.log(dataItem)
        const res = await createJobFunc({
            variables: {
        ...
        if (res?.data?.CreateJobPost?.success) {
...
export default Admin_CareerCreate